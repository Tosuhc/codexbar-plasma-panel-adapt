...
require_in_file "$MAIN_QML" "Components.InteractiveChart"
require_in_file "$MAIN_QML" "function costChartPoints(points)"
...
require_in_file "$MAIN_QML" "function processPaceNotifications(item, nextMemo)"
...
require_in_file "$MAIN_QML" '"sessions", "--json-v2"'
require_in_file "$MAIN_QML" "function parseSessionsOutput(stdoutText, stderrText)"
require_in_file "$MAIN_QML" "function normalizeSession(item)"
