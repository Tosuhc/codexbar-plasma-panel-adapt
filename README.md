...
- Local **Sessions** view backed by `sessions --json-v2`; transcript paths and
  working directories are never rendered or opened. The tab is hidden in this
  fork build but the view code remains for re-enablement.
